const sounds = [
  ...
  },
  {
    ...
    note: "The circumflex is a hat that shows the vowel is stretched. In old French, there used to be an 's' after it — 'pâte' was once 'paste'. You can see it in English cognates: château → castle, forêt → forest."
  },
  {
    id: "e",
    letter: "E e",
    ...
    variations: [
      { letter: "É é", id: "e-acute" },
      { letter: "È/Ê", id: "e-grave" },
    ],
  ...
  },
  {
    ...
    phonetic: "ay",
    ipa: "/e/",
    description: "The acute accent (é) lifts the sound up into a bright, crisp 'ay' — but without the glide you hear in English 'say' (which drifts into 'ee' at the end). Keep it short and clean, mouth in a slight smile.",
    englishExamples: ["say (but cut it short)", "café", "résumé", "fiancée"],
    frenchWords: [
      { fr: "été", en: "summer", ph: "ay-TAY" },
      { fr: "café", en: "coffee", ph: "kah-FAY" },
      { fr: "bébé", en: "baby", ph: "bay-BAY" },
      { fr: "école", en: "school", ph: "ay-KOL" },
      { fr: "aller", en: "to go", ph: "ah-LAY" },
    ],
    relatedTo: [{ letter: "E e", id: "e" }],
    note: "You already know this sound! The words café, résumé, and fiancée came directly from French into English — complete with their accents."
  },
  {
    id: "e-grave",
    letter: "È è / Ê ê",
    ...
    phonetic: "eh",
    ipa: "/ɛ/",
    description: "The grave accent (è) or circumflex (ê) both open the E sound into a fuller 'eh' — like English 'bed' or 'get'. Your mouth opens a bit more than for É. These two accents make virtually the same sound in modern French.",
    englishExamples: ["bed", "get", "set", "elephant"],
    frenchWords: [
      { fr: "père", en: "father", ph: "PAIR" },
      { fr: "mère", en: "mother", ph: "MAIR" },
      { fr: "frère", en: "brother", ph: "FRAIR" },
      { fr: "fête", en: "party/feast", ph: "FET" },
      { fr: "lèvre", en: "lip", ph: "LEV-ruh" },
    ],
    relatedTo: [{ letter: "E e", id: "e" }, { letter: "É é", id: "e-acute" }],
    note: "The grave accent ( ` ) goes downward like a slide going down. The circumflex ( ^ ) is the little hat. Both make the same open 'eh' sound."
  },
  {
    id: "i",
    letter: "I i",
    ...
    variations: [
      { letter: "Î î", id: "i-circumflex" },
    ],
    note: "Good news: I is one of the most reliable French vowels. It almost never changes. The only exception is when it comes before another vowel — then it can sound like the English 'y' in 'yes' (called a glide)."
  },
  {
    id: "i-circumflex",
    letter: "Î î",
    ...
    phonetic: "ee",
    ipa: "/i/",
    description: "The circumflex hat on Î doesn't change the sound at all — it's still the same 'ee' as regular I. The hat is just a historical marker (there used to be an 's' after it in old French). Pronounce it exactly like I.",
    ...
    note: "Île (island) shows the pattern: the English word 'isle' still has the S that disappeared in French! The same pattern: île/isle, forêt/forest, pâte/paste."
  },
  {
    id: "o",
    letter: "O o",
    ...
    phonetic: "oh",
    ipa: "/o/ or /ɔ/",
    description: "French O has two versions: a closed 'oh' (lips rounded and forward, like you're about to whistle) and an open 'aw' (mouth more open, like English 'hot' or 'not'). Don't worry too much about which is which — just round your lips and you'll be understood!",
    ...
    frenchWords: [
      ...
      { fr: "or", en: "gold", ph: "OR" },
      { fr: "foto", en: "photo", ph: "FOH-toh" },
    ],
    variations: [
      { letter: "Ô ô", id: "o-circumflex" },
    ],
    note: "When O comes at the end of a word or is followed by a silent consonant, it's usually the closed 'oh'. Otherwise it's more open. But honestly — round your lips and go for it!"
  },
  {
    id: "o-circumflex",
    letter: "Ô ô",
    label: "Ô",
    sub: "rounder, more closed 'oh'",
    color: "orange",
    phonetic: "oh (rounder)",
    ipa: "/o/",
    description: "The circumflex makes O more closed and rounded — lips pushed forward like you're blowing out a candle. It's a pure 'oh' with no drift into 'oo'. Think of a perfectly round circle with your lips.",
  ...
  },
  {
    ...
    letter: "U u",
    label: "U",
    sub: "no English equivalent!",
    color: "violet",
    phonetic: "ew (rounded)",
    ipa: "/y/",
    description: "This is THE most uniquely French sound — there's nothing like it in English. Start by saying 'ee' (like in 'see'), then WITHOUT moving your tongue, round your lips forward like you're about to say 'oo'. Hold that tension. It feels very strange at first — that's normal!",
    ...
    variations: [
      { letter: "Û û", id: "u-circumflex" },
      { letter: "OU ou", id: "ou" },
    ],
    note: "Don't be discouraged if this takes time — it's genuinely the hardest French sound for English speakers. The trick: say 'ee', freeze your tongue, then round your lips. Practice with 'tu' (you) since you'll use it constantly!"
  },
  {
    id: "u-circumflex",
    letter: "Û û",
    label: "Û",
    sub: "same as U, just longer",
    color: "violet",
    phonetic: "ew (longer)",
    ipa: "/y/",
    description: "Exactly the same rounded 'ew' sound as regular U — the circumflex just marks a historical spelling change. Pronounce it identically to U.",
  ...
  },
  {
    ...
    phonetic: "oo",
    ipa: "/u/",
    description: "When O and U sit together, they make a simple 'oo' sound — just like English 'you', 'boot', or 'moon'. Lips round and pushed forward. This is DIFFERENT from the French U — OU is the easier one! Same mouth shape but without the tongue tension.",
  ...
  },
  {
    ...
    letter: "EU eu / ŒU œu",
    label: "EU",
    sub: "like 'uh' with rounded lips",
    color: "teal",
    phonetic: "uh (rounded)",
    ipa: "/ø/ or /œ/",
    description: "EU and ŒU both make a rounded 'uh' sound — like English 'her' or 'bird', but with your lips pushed forward into a circle. Try saying 'uh' and then round your lips without changing your tongue position. It's related to the French U trick!",
    ...
    note: "EU appears in one of the most useful words: 'deux' (two) and 'bleu' (blue). You'll recognise bleu from 'fromage bleu' — blue cheese! The ŒU combination (as in 'cœur', heart) makes the same sound."
  },
  {
    id: "an",
    letter: "AN/AM · EN/EM",
    ...
    phonetic: "ahn (nasal)",
    ipa: "/ɑ̃/",
    description: "This is a NASAL vowel — air flows through your nose as well as your mouth. Say 'ah', then let some sound come out through your nose at the same time — but don't fully say the 'n'. Think of it like a soft, humming 'ah' that resonates in your face. AN, AM, EN, and EM all make this same nasal sound.",
    englishExamples: ["(no direct equivalent)", "like 'on' in French restaurant", "the 'an' in 'encore' when said with a French accent"],
    frenchWords: [
    ...
    variations: [
      { letter: "IN/IM · UN", id: "in" },
      { letter: "ON/OM", id: "on" },
    ],
    note: "Nasal vowels are one of the most distinctive French features! The key: you don't fully pronounce the N or M — they just 'nasalise' the vowel before them. AN, AM, EN, EM all sound the same: a nasal 'ahn'."
  },
  {
    id: "in",
    letter: "IN/IM · UN · AIN",
    ...
    phonetic: "an (nasal)",
    ipa: "/ɛ̃/",
    description: "Another nasal vowel — this time, say 'eh' (like in 'bed') and let it resonate through your nose without closing your lips to fully say the N. IN, IM, UN, AIN, AIM, EIN all make this same nasal 'an' sound. (It's different from AN — this one is brighter and higher.)",
    englishExamples: ["(no direct equivalent)", "like the 'in' in 'international' said with a French accent", "similar to English 'an' but more nasal"],
    frenchWords: [
  ...
  },
  {
    ...
    phonetic: "ohn (nasal)",
    ipa: "/ɔ̃/",
    description: "The third nasal vowel — say 'oh' with rounded lips and let it hum through your nose simultaneously. ON and OM both make this sound. It's a round, resonant sound — almost like you're saying 'own' but stopping before the W.",
  ...
  },
  {
    ...
    letter: "R r",
    label: "R",
    sub: "the famous French R",
    color: "red",
    phonetic: "r (guttural)",
    ipa: "/ʁ/",
    description: "The French R is made at the BACK of your throat — not the front like English R. Imagine gargling gently, or the sound you make when clearing your throat very softly. Your tongue stays flat; the back of your tongue rises toward your uvula (the dangly thing at the back). Try saying 'ah' and then constrict the back of your throat slightly.",
    englishExamples: ["(no equivalent — this is uniquely French!)", "similar to the sound before spitting (but much gentler)", "like the Spanish J in 'Juan'"],
    frenchWords: [
    ...
    note: "The French R is intimidating but becomes natural with practice. Until it does, a gentle English R at the back of the throat works fine — French people will understand you. Don't let the R stop you from speaking!"
  },
  {
    id: "ch",
    letter: "CH ch",
    ...
    phonetic: "sh",
    ipa: "/ʃ/",
    description: "French CH makes a 'sh' sound — like English 'shoe', 'sheep', or 'push'. Your lips push forward slightly and your tongue is near (but not touching) the roof of your mouth. Important: it is NEVER a hard 'ch' like in English 'cheese' or 'church'.",
  ...
  },
  {
    ...
    phonetic: "ny",
    ipa: "/ɲ/",
    description: "GN makes a 'ny' sound — exactly like the N in English 'canyon' or 'onion'. Your tongue touches the roof of your mouth while making an N sound. It's the same as the Spanish Ñ. Once you hear it, you'll recognise it everywhere.",
    ...
    note: "Montagne (mountain) gives us the English word 'mountain'. Champagne — that's a region of France, and GN makes it 'sham-PAN-yuh'. You've been saying French sounds all along!"
  },
  {
    id: "oi",
    letter: "OI oi",
  ...
  {
    id: "au",
    letter: "AU au / EAU eau",
    label: "AU / EAU",
    sub: "as in 'go'",
    color: "orange",
    phonetic: "oh",
    ipa: "/o/",
    description: "AU and EAU both make a clean 'oh' sound — exactly like a closed French O. EAU looks like a lot of letters for one sound, but just say 'oh'! These are some of the most reliable spelling patterns in French.",
  ...
  {
    id: "silent",
    letter: "Letters silencieuses",
    label: "Silent Letters",
    sub: "what you don't say",
    color: "slate",
    phonetic: "(silence)",
    ipa: "Ø",
    ...
    englishExamples: ["(no equivalent — English rarely does this)", "like the silent K in 'knife'", "like the silent B in 'lamb'"],
    frenchWords: [
  ...
  },
  {
    ...
    letter: "La liaison",
    label: "Liaison",
    sub: "words that link together",
    color: "slate",
    phonetic: "(linking sounds)",
    ipa: "—",
  ...
  },
  {
    ...
    letter: "Ç ç",
    label: "Ç",
    sub: "always sounds like S",
    color: "indigo",
    phonetic: "s",
    ipa: "/s/",
    description: "The cedilla (the little tail under the C) always makes a soft 'S' sound. Without the cedilla, C before A, O, or U makes a hard 'K' sound. The cedilla is a reminder: 'I'm a soft C!' Think of it as a little S dangling below.",
  ...
  },
  {
    ...
    letter: "J j",
    label: "J",
    sub: "like the S in 'measure'",
    color: "indigo",
    phonetic: "zh",
    ipa: "/ʒ/",
    description: "French J is NEVER like English J (which sounds like 'dge' in 'judge'). Instead it's a smooth, buzzing 'zh' — the sound in the middle of English 'measure', 'treasure', or 'television'. Your mouth is slightly open, tongue near the roof, air flows continuously.",
  ...
  },
  {
    ...
    letter: "H h",
    label: "H",
    sub: "almost always silent",
    color: "slate",
    phonetic: "(silent)",
    ipa: "Ø or /h/",
    description: "In French, H is almost always completely silent — you simply ignore it. 'Heure' (hour) = 'uh'. There are two types: H muet (silent H, which allows liaison) and H aspiré (which blocks liaison) — but for beginners, just treat all H as silent and you'll be right most of the time.",
    ...
    note: "English has silent H too — 'honest', 'hour', 'heir'. French just does it much more often! When you see H, just skip straight to the vowel after it."
  }
];
